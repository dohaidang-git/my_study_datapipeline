"""Load raw Olist sellers into the bronze layer."""
...
def transform(df: DataFrame) -> DataFrame:
    return (
        df.withColumn("seller_zip_code_prefix", F.col("seller_zip_code_prefix").cast("string"))
...
def main() -> None:
    ...
    spark = build_spark_session("load_sellers_bronze")
